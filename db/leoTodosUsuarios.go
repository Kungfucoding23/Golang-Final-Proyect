...
//LeoTodosUsuarios lee todos los usuarios registrados en el sistema, si se recibe "R" en quienes trae solo los que se relacionan conmigo
//El ID del usuario que esta leyendo los usuarios
//La pagina porque si hay muchos hay que paginar
//El search que es una palabra para la busqueda (todos los usuarios que contengan la palabra search)
//El tipo de busqueda que vamos a hacer, si listamos todos, solo los que nos siguen, o los que seguimos
//Devuelve un slice del tipo Usuario ya que devolvemos n usuarios que responden a la busqueda y un booleano
