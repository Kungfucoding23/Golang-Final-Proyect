...
/*
	Con respecto a las imágenes veremos ahora todo lo referente a subirAvatar y subirBanner. Si bien para realizar estas acciones debemos llamar a grabar en la base de datos, no tendremos un archivo .go en la carpeta bd porque reutilizaremos el de modificoRegistro.go ya que las imágenes son campos de los usuarios y ya tenemos hecha la rutina para modificar a los campos de los usuarios.
*/
...
func SubirAvatar(w http.ResponseWriter, r *http.Request) {
	...
	/*Ahora vamos a grabar en la db el cambio en el campo avatar */
